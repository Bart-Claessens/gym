...
for i in range(0, amountSeries):
    ...
    rewardMatrix[i] = doQLearning(amountOfEpisodes = amountEpisodes)
    rewardMatrixShielding[i] = doQLearning(amountOfEpisodes = amountEpisodes, alpha = alpha, shielding=True)
    rewardMatrixRewardShaping[i] = doQLearning(amountOfEpisodes = amountEpisodes, alpha = alpha, rewardShaping=True)
